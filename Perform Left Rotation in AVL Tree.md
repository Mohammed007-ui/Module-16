...
# Insert initial nodes to cause imbalance
values = [10, 20, 30, 40, 50, 25]
for v in values:
    root = avl.insert(root, v)

print("Preorder traversal before inserting 7:")
avl.preOrder(root)
print("\n")

# Insert '7' to trigger left rotation if needed
root = avl.insert(root, 7)

print("Preorder traversal after inserting 7 (with rotations if needed):")
avl.preOrder(root)
print()
...
## OUTPUT
![image](https://github.com/user-attachments/assets/79ee0ee3-48dd-4c79-9755-ad81c366da7d)


## RESULT
The program inserts the nodes into the AVL tree and performs the necessary left rotations to maintain balance. After inserting 7, the AVL tree remains balanced, and the pre-order traversal correctly reflects the updated structure.
